public class OperadorInstanceOf {
    public static void main(String[] args){
        ...
        String texto2 = new String("Sara"); //De forma explicita
        Integer numero = 365; //De forma literal se puede crear un Integer
        Integer numero2 = new Integer(24); //De forma explicita
        Double decimal = 7.7; //De forma literal se puede crear un Double
        Double decimal2 = new Double(7.7);  //De forma explicita
        Boolean b1 = false; //De forma literal se puede crear im Boolean
        Boolean b2 = new Boolean(false); //De forma explicita
